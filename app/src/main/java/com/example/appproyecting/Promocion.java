...
public class Promocion extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View prom = inflater.inflate(R.layout.fragment_promocion, container, false);
        ...
        P1.setImageResource(R.drawable.camra);
    ...
    public void Pago (){
        String mensaje = "";
        String contacto = "+50373823381";
        Uri abrir = Uri.parse("http://wa.me/" + contacto + "/?text=" + mensaje);
        Intent Whatapp = new Intent(Intent.ACTION_VIEW, abrir);
        startActivity(Whatapp);
    }
    public void Abri_Frame3(){
        Intent frame = new Intent(getActivity(), Acerca_DE.class);
        startActivity(frame);
    }
}